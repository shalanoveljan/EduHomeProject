...
namespace EduHome.App.Areas.Admin.Controllers
{
    ...
    public class CategoryOfEventController : Controller
    {
        ...
        public async Task<IActionResult> Create(CategoryOfEventPostDto dto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(int id, CategoryOfEventPostDto dto)
        {
            if (!ModelState.IsValid)
            {
                return View();
