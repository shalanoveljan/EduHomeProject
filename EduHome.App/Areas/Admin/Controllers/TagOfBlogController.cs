...
namespace EduHome.App.Areas.Admin.Controllers
{
    ...
    public class TagOfBlogController : Controller
    {
        readonly ITagOfBlogService _tagService;

        public TagOfBlogController(ITagOfBlogService TagService)
        {
        ...
        public async Task<IActionResult> Create(TagOfBlogPostDto dto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(int id, TagOfBlogPostDto dto)
        {
            if (!ModelState.IsValid)
            {
                return View();
